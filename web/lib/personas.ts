...
const minister: Persona = {
  ...
  questions: [
    ...
    {
      text: "요즘 일상 속에서, 소명대로 살고 있다고 느껴졌던 순간이 있나요?",
      suggestedAnswers: [
        "예배 인도 후 함께 기도하던 한 성도의 표정에서 회복이 보였을 때",
      ],
    },
  ],
};
...
const worker: Persona = {
  ...
  age: 29,
  role: "직장인",
  tagline: "차분한 관점, 사람을 깊이 읽는",
  cardSubtitle: "직장인 — 사회 초·중년",
  welcome:
    "다은님, 반갑습니다. 회의실과 책상 사이에서 오늘도 분주하셨죠? 오늘은 잠깐 나 자신에게 집중하는 시간을 가져보시겠어요?",
  // Q1·Q2: 일반 직장인 톤 (기존 신앙 톤은 기독교 리더 시연용 별도 분기 예정)
  questions: [
    {
      text: "오늘 하루 중에서, 시간 가는 줄 모르고 빠져들었던 한 순간이 있나요?",
      suggestedAnswers: [
