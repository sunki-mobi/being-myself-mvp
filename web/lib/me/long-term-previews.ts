  ...
  layers: [
    {
      ...
      quotes: [
        ...
        {
          day: 47,
          text: "심방 가서 길게 들어드렸는데 '덕분에 마음이 풀렸다'는 말을 들었을 때",
        },
      ],
  ...
  layers: [
    {
      ...
      friendlyTitle: "나의 일상",
      summary:
        "다은님의 하루는 두 흐름이 함께 흘러요. 회의실의 일, 그리고 퇴근 후 좋아하는 일에 푹 빠지는 자기만의 시간. 그 사이에 회의가 막혔을 때 '다은님은 어떻게 보세요?'라는 물음을 자연스레 받는 시간이 있어요. 일과 사람과 신앙이 따로 가지 않아요.",
      quotes: [
        {
          day: 12,
