  ...
  layers: [
    {
      ...
      friendlyTitle: "나의 일상",
      summary:
        "다은님의 하루는 두 흐름이 함께 흘러요. 회의실의 일, 그리고 퇴근 후 좋아하는 일에 푹 빠지는 자기만의 시간. 그 사이에 '이 일도 하나님이 주신 자리'라고 마음이 잡히는 순간이 자연스레 있어요. 일과 사람과 신앙이 따로 가지 않아요.",
      quotes: [
        {
          day: 12,
        ...
        {
          day: 47,
          text: "맡은 자리에서 '이 일도 하나님이 주신 자리'라고 마음잡힌 순간",
        },
      ],
    ...
    },
    {
      ...
      friendlyTitle: "나에게 소중한 것",
      summary:
        "가장 소중히 여기는 건 '일이 사람을 잃지 않는 자리'예요. 성과 숫자만 보는 회사가 아니라 한 사람 한 사람의 마음이 살아 있는 자리. 신앙이 일요일에만 있지 않고 평일 책상 위에도 흐르는 모습. 그게 6개월 답변 곳곳에 있었어요.",
      quotes: [
        {
          day: 56,
        ...
        {
          day: 142,
          text: "신앙이 회사 밖에만 있는 게 아니라 일하는 책상 위에도 있었으면 좋겠어요",
        },
      ],
      keywords: ["사람 우선", "일·신앙 통합"],
    },
    {
      layer: "존재",
      friendlyTitle: "되고 싶은 나의 모습",
      summary:
        "되고 싶은 모습은 '일이 사람을 잃지 않게 만드는 사람'이에요. 다은님이 있는 회의실, 다은님이 함께한 프로젝트가 한 사람의 마음이 살아 있는 자리가 되는 모습. 일과 신앙이 하나로 흐르는 모습. 그 자리로 가까워지는 6개월이었어요.",
      quotes: [
        {
          day: 95,
        ...
        {
          day: 178,
          text: "일과 신앙이 하나로 흐르는 사람이 되고 싶어요",
        },
      ],
